...
void Rect::draw(Window& const fensterchen) const
{
    ...
    fensterchen.draw_line(min_.x, min_.y, max_.x, min_.y, rgb_.r, rgb_.g, rgb_.b);
    //obere waagerechte Linie
    fensterchen.draw_line(min_.x, max_.y, max_.x, max_.y, rgb_.r, rgb_.g, rgb_.b);
    //linke horizontale Linie
    fensterchen.draw_line(min_.x, min_.y, min_.x, max_.y, rgb_.r, rgb_.g, rgb_.b);
    //recte horizontale Linie
    fensterchen.draw_line(max_.x, max_.y, max_.x, min_.y, rgb_.r, rgb_.g, rgb_.b);
}
